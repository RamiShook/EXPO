<a href='#' class="mdl-navigation__link" id="usern" disabled><?php chkss() ?></a>
        <!--  index.php?profile  -->
          ...
          <a class="mdl-navigation__link" href="./Requests.php">Show Return/Replacement Requests(Multi).</a>
          <a class="mdl-navigation__link" href="./Requests.php">Show Return/Replacement Requests(One).</a>
