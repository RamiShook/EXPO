...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 23, 2020 at 02:58 PM
...
(50, 2, 1, '', '2020-07-30 09:12:52', 0, 'Pending'),
...
(64, 1, 5, '200000', 3955149),
(64, 2, 5, '75000', 9982114),
(67, 1, 2, '80000', 70789),
...
INSERT INTO `products` (`product_id`, `Product_Name`, `product_Code`, `product_Size`, `product_Color`, `product_Quantity`, `product_Price`, `product_Note`, `product_Availability`, `product_photo_path`) VALUES
(1, 'Shoe', '123456', '36', 'Black', 45, 40000, NULL, 'A', './photo/123456.jpg'),
(2, 'heel', '321456', '37', 'Red', 49, 15000, 'Comming Soon', 'A', ''),
(3, 'Product 1', '782123', '36', 'Yellow', 15, 50000, NULL, 'A', './photo/782123.jpg'),
(4, 'Product 2', '383939', '34', 'Blue', 18, 40000, 'njnjnjnjnjnjnjnjnjnjnj nj njnjnjnjn jnjnjnjnjn jnjnj', 'A', './photo/383939.jpg'),
(5, 'Product 3', '32e232', '37', 'Black', 60, 200000, 'Not Available For Testing', 'A', './photo/32e232.jpg'),
(26, '', 'c200BLK38', '38', 'Black', 20, 30000, '', 'A', ''),
(27, '', 'c200BLK36', '36', 'Black', 20, 30000, '', 'A', ''),
(28, '', 'c200BLK39', '39', 'Black', 17, 30000, '', 'A', ''),
(29, '', 'c200BLK37', '37', 'Black', 10, 30000, '', 'A', ''),
(30, '', 'c200BLK40', '40', 'Black', 10, 30000, '', 'A', ''),
(31, '', 'c200BLK41', '41', 'Black', 10, 30000, '', 'A', '');
...
CREATE TABLE `reserved` (
  ...
  `reverse_Status` char(1) NOT NULL DEFAULT 'w' COMMENT 'W:Waiting,D:Done',
...
(4, 1, 2, 1, 'w', 'MayBeCancelled', '2020-07-18 00:17:45', 80000, 2, 0),
(13, 5, 2, 13, 'w', '', '2020-07-18 23:15:02', 4000000, 20, 0),
(15, 2, 1, 14, 'w', 'Dlivery!', '2020-07-19 01:35:35', 15000, 1, 0),
(19, 1, 2, 1, 'w', '', '2020-07-20 16:57:10', 200000, 5, 0),
(20, 4, 2, 1, 'w', 'b hbhbh', '2020-07-23 12:49:46', 0, 5, 0),
(162, 4, 2, 14, 'w', '', '2020-07-25 01:08:08', 200000, 5, 0);
...
--
ALTER TABLE `change_details`
  MODIFY `change_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
...
--
ALTER TABLE `multiple_reserved`
  MODIFY `multiple_reserve_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
...
--
ALTER TABLE `change_details`
  ADD CONSTRAINT `change_details_ibfk_1` FOREIGN KEY (`new_order_details_product_id`) REFERENCES `products` (`product_id`),
...
--
-- Constraints for table `change_order`
--
ALTER TABLE `change_order`
  ADD CONSTRAINT `change_order_ibfk_2` FOREIGN KEY (`old_product_id`) REFERENCES `products` (`product_id`);
